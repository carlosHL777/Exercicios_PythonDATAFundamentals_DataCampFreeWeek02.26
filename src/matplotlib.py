...
print(year[-1], pop[-1]) #type: ignore
...
print(life_exp[-1]) #type: ignore
print(gdp_cap[-1]) #type: ignore

# Make a line plot, gdp_cap on the x-axis, life_exp on the y-axis
plt.plot(gdp_cap, life_exp) #type: ignore
